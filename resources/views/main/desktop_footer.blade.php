<footer class="d-flex flex-column">
    ...
    <div class="footerBottom container">
        <p class="text"><sup>1</sup>Цена на автомобиль JAECOO J7 с двигателем 1.6 Turbo 2WD. Предложение ограничено, не является офертой (в соответствии со ст. 437, 494 ГК РФ).<br>
            <sup>2</sup>Предложение ограничено, не является офертой (в соответствии со ст. 437, 494 ГК РФ).<br>
            <sup>3</sup>Цена на автомобиль JAECOO J7 с двигателем 1.6 Turbo AWD. Предложение ограничено, не является офертой (в соответствии со ст. 437, 494 ГК РФ).
        </p>
...
<div class="sidenav">
    <div class="sidenav-block d-flex flex-column">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="close" onclick="document.querySelector('.sidenav').classList.remove('active'); document.querySelector('body').style.overflowY='auto';">
                <div></div>
                <div></div>
            </div>
        </div>
...
<div class="ask-overlay ask-call align-items-center justify-content-center fromAskMeSpec as" style="display: none;">
...
{{--                    модалка находится в desktop_main.blade.php  /views --}}
...
<div class="ask-overlay ask-ok align-items-center justify-content-center" style="display: none;">
    <div class="ask-block-content">
        ...
        <div class="header d-flex flex-column">
            ...
            <p class="request mb-0">Заявка успешно отправлена</p>
            <p class="additional mb-0">Мы свяжемся с вами для уточнения деталей и ответим на все вопросы</p>
        </div>
    </div>
</div>
